...
describe ApplicationController do
  ...
  describe 'Homepage' do
    context 'logged in' do
      it 'lets a user view the homepage if logged in' do
    ...
    context 'logged out' do
      it 'does not let a user view the homepage if not logged in' do
        get '/'
   ...
   describe "Signup Page" do
    ...
    it 'signup directs user to home page' do
      params = {
  ...
  describe "login" do
    ...
    it 'loads the home page after login' do
  ...
  describe "logout" do
    ...
    it 'does not load home page if user not logged in' do
      get '/'
      expect(last_response.location).to include("/login")
    end

    it 'does load home page if user is logged in' do
      user = User.create(:username => "becky567", :email => "starz@aol.com", :password => "kittens")
  ...
  describe 'user show page' do
    it 'shows all a single user workouts' do
      user = User.create(:username => "becky567", :email => "starz@aol.com", :password => "kittens")
      workout1 = Workout.create(:name => "Workout One", :user_id => user.id)
     get "/users/#{user.slug}"

      expect(last_response.body).to include("Workout One")
  ...
  describe 'index action' do
    context 'logged in' do
      it 'lets a user view the workouts index if logged in' do
        user1 = User.create(:username => "becky567", :email => "starz@aol.com", :password => "kittens")
        workout1 = Workout.create(:name => "test", :user_id => user1.id)

        user2 = User.create(:username => "silverstallion", :email => "silver@aol.com", :password => "horses")
        workout2 = Workout.create(:name => "look at this tweet", :user_id => user2.id)
        ...
        click_button 'submit'
        visit "/workouts"
        expect(page.body).to include(workout1.name)
        expect(page.body).to include(workout2.name)
      end
    end
  ...
  describe 'new action' do
    context 'logged in' do
      it 'lets user view new exercise form if logged in' do
        user = User.create(:username => "becky567", :email => "starz@aol.com", :password => "kittens")
      ...
      it 'lets user create an exercise if they are logged in' do
        user = User.create(:username => "becky567", :email => "starz@aol.com", :password => "kittens")
